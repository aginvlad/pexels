    ...
    <>
      ...
      >
        <div className="modal-wrapper">
          <img
            src={`${photo}?auto=compress&cs=tinysrgb&h=650&w=940`}
            alt=" "
        ...
        <div className="modal-sidebar">
          <div className="modal-sidebar__btn">
            <a
              ...
              download
              className="modal-sidebar__btn__download"
            >
              <svg
            ...
            <button
              className="modal-sidebar__btn__more"
              onMouseOver={props.showOtherSize}
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="8"
            ...
            <form
              onSubmit={e => props.downloadSelectedPhoto(e)}
              className="modal-sidebar__form"
            >
              <h3>Download Size</h3>
