...
class StockPhotos extends Component {
  ...
  showModalHandler = e => {
    ...
    this.setState({ modal: true, photosUrl, item: e.item });
  };
  ...
  downloadSelectedPhotoHandler = e => {
    ...
    const selectedRadio = document.querySelector(
      'input[name="download-size"]:checked'
    );
    const option = document.querySelector('label[for=' + selectedRadio.id + ']')
      .textContent;
    const form = document.querySelector('.modal-sidebar__form');
    ...
    if (this.props.colOne.length === 0)
      return (
        <h2 className="error-title">
          Sorry, no pictures found! Try more unspecific terms
        </h2>
      );
    return (
      <>
        <Modal
          ...
          showOtherSize={this.showOtherSizeHandler}
          ...
          <div className="stock-photos__gallery__column">
            {this.props.colOne.map(el => {
              ...
              return (
                <div
                  key={el.id}
                  className="stock-photos__gallery__column__item"
                >
                  <img
                    large={el.src.large}
                    medium={el.src.medium}
                    small={el.src.small}
                    src={`${
                      el.src.original
                    ...
                    srcSet={`${
                      el.src.original
                    }?auto=compress&cs=tinysrgb&dpr=1&w=500 1x, ${
                      el.src.original
                    }?auto=compress&cs=tinysrgb&dpr=2&w=500 2x`}
                    alt=" "
                  ...
                  <div className="stock-photos__gallery__column__item__overlay">
                    ...
                    <div className="stock-photos__gallery__column__item__overlay__buttons">
                      ...
                      <button
                        className={el.isLiked}
                        onClick={e => this.addLikeHandler(e.target, el.id)}
                      >
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          width="25px"
                        ...
                        >
                          <path
                            d="M84.417 38.466c0 5.63-2.407 10.7-6.248 14.233L50 80.866 21.832 52.7c-3.842-3.535-6.25-8.604-6.25-14.234 0-10.677 8.656-19.333 19.334-19.333 5.492 0 10.45 2.29 13.97 5.968.39.41.763.834 1.114 1.274.354-.44.725-.865 1.115-1.273 3.52-3.676 8.478-5.967 13.97-5.967 10.677 0 19.332 8.656 19.332 19.333z"
                            stroke="#fff"
                            strokeWidth="8"
                            fill="transparent"
                          />
